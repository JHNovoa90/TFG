...
namespace Sistema
{
    public partial class frmRegistrarEgresos : Form
    {
        ...
        public frmRegistrarEgresos(Persona obj)
        {
            opersona = obj;
            InitializeComponent();
        }
        ...
        private void btnterminar_Click(object sender, EventArgs e)
        {
            ...
            if (dgdata.Rows.Count > 0)
            {
                ...
                {
                    dgdata.Rows.Clear();
                    MessageBox.Show("Los gastos fueron registrados", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
        ...
        {
            using (var form = new mdListaServicios("GASTOS"))
            {
                var result = form.ShowDialog();
                if (result == DialogResult.OK)
                {
